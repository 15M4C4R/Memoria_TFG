...
El diseño de la arquitectura del sistema constituye el núcleo estructural del proyecto. Se basa en un modelo cliente-servidor fuertemente desacoplado pero integrado bajo un mismo flujo de desarrollo. En la Fig.~\ref{fig:arquitectura} se ilustra el esquema general del sistema y sus flujos de comunicación físicos.
