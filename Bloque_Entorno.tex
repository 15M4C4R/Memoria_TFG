...
\chapter[Iteración 1: Configuración de Entornos y Metodología]{Iteración 1: Configuración de Entornos, Planificación Inicial y Metodología Base}
...
Se materializa el calendario inicial, detallando la distribución de tareas por semanas (quedando reflejado en la Fig.~\ref{fig:gantt_planificacion}). Asimismo, se redacta e implementa la metodología en GitHub con las siguientes especificaciones técnicas:
\begin{itemize}
...
\chapter[Iteración 2: Interfaces, Orquestación y CI/CD]{Iteración 2: Diseño de Interfaces, Orquestación de Datos y Configuración de Testing y CD}
