...
\chapter[Iteración 11: Acciones Pendientes y Modales]{Iteración 11: Sistema de Acciones Pendientes, Interfaces Asíncronas y Modales de Cartas}
...
\chapter[Iteración 12: Consolidación del Motor de Juego]{Iteración 12: Consolidación Funcional del Motor de Juego y Lógica de Cartas}
...
La fase de ejecución técnica se desarrolla siguiendo un ciclo de verificación funcional manual. Utilizando la lista definida en la fase de diseño, se procede a verificar cada acción individualmente en el entorno local, revisando los cambios tanto en Redis como en el cliente. El procedimiento se ejecuta bajo los siguientes pasos:
\begin{itemize}
...
\chapter[Iteración 13: Bucle de Partida e Infiltración]{Iteración 13: Estabilización del Bucle de Partida y Mecánica de Infiltración}
...
\chapter[Iteración 14: Pulido de Reglas y Corrección de Errores]{Iteración 14: Pulido de Reglas, Corrección de Errores y Refactorización Estructural}
...
\chapter[Iteración 15: Notificaciones y Reconexión Activa]{Iteración 15: Notificaciones Globales, Reconexión Activa y Alertas de Partida}
...
\chapter[Iteración 16: Pruebas Automatizadas y Despliegue]{Iteración 16: Automatización de Pruebas, Cobertura de Código y Despliegue Final}
...
\chapter[Iteración 17: Redacción y Consolidación Documental]{Iteración 17: Redacción Técnica y Consolidación Documental}
